"""
Rollout ramp progression test.
"""
import asyncio
from types import SimpleNamespace


def test_rollout_ramp_progression(monkeypatch):
    ...
    bot.config = SimpleNamespace(rollout=SimpleNamespace(traffic_split_pct=0), rollout_ramp=RolloutRampConfig(enabled=True, steps_pct=[0,10,20], step_interval_sec=10))
